...
class BIP66Test(SchleemsTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # schleemsd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and schleemsd produces more specific reject
            # reasons.
