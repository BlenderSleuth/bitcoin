...
class TxnMallTest(SchleemsTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 SLM:
        ...
        # Node0's balance should be starting balance, plus 50SLM for another
        ...
        # Node0's total balance should be starting balance, plus 100SLM for 
