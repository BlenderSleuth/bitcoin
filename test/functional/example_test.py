...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SchleemsTestFramework
    pass

class ExampleTest(SchleemsTestFramework):
    # Each functional test is a subclass of the SchleemsTestFramework class.
    ...
    def custom_method(self):
        ...
        SchleemsTestFramework class so other tests can use it."""
