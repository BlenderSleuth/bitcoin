...
By default, schleemsd will dump mempool on shutdown and
...
class MempoolPersistTest(SchleemsTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give schleemsd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent schleemsd from writing mempool.dat to disk. Verify that `savemempool` fails")
