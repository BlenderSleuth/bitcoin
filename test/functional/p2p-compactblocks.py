...
# TestNode: A peer we use to send messages to schleemsd, and store responses.
...
class CompactBlocksTest(SchleemsTestFramework):
    ...
    # This test actually causes schleemsd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that schleemsd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for schleemsd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # schleemsd will not send blocktxn responses for blocks whose height is
