...
#ifndef SCHLEEMS_QT_SCHLEEMSUNITS_H
#define SCHLEEMS_QT_SCHLEEMSUNITS_H
...
/** Schleems unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SchleemsUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SchleemsUnits(QObject *parent);

    /** Schleems units.
      @note Source: https://en.schleems.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SLM,
...
typedef SchleemsUnits::Unit SchleemsUnit;

#endif // SCHLEEMS_QT_SCHLEEMSUNITS_H
