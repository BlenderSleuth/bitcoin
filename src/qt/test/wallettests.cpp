...
#include "qt/schleemsamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<SchleemsAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_schleems-qt -platform xcb      # Linux
//     src/qt/test/test_schleems-qt -platform windows  # Windows
//     src/qt/test/test_schleems-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = SchleemsUnits::formatWithUnit(unit, balance, false, SchleemsUnits::separatorAlways);
    ...
    // Amount input
    SchleemsAmountField* amountInput = receiveCoinsDialog.findChild<SchleemsAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: schleems:")) != -1);
