 ...
 * between schleemsd, and schleems-qt and non-server tools.
*/
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), SCHLEEMS_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/schleems/schleems>";
    const std::string URL_WEBSITE = "<https://schleemscore.org>";
...
/** Sanity checks
 *  Ensure that Schleems is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Schleems process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", SCHLEEMS_CONF_FILENAME)).string());
