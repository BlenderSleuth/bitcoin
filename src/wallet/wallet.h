...
#ifndef SCHLEEMS_WALLET_WALLET_H
#define SCHLEEMS_WALLET_WALLET_H
...
public:
     ...
     * on this schleems node, and set to 0 for transactions that were created
...
#endif // SCHLEEMS_WALLET_WALLET_H
