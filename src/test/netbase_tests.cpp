...
{
    BOOST_CHECK(TestSplitHost("www.schleems.org", "www.schleems.org", -1));
    BOOST_CHECK(TestSplitHost("[www.schleems.org]", "www.schleems.org", -1));
    BOOST_CHECK(TestSplitHost("www.schleems.org:80", "www.schleems.org", 80));
    BOOST_CHECK(TestSplitHost("[www.schleems.org]:80", "www.schleems.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:4579", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4579", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4579", "::ffff:127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[::]:4579", "::", 8333));
    BOOST_CHECK(TestSplitHost("::4579", "::8333", -1));
    BOOST_CHECK(TestSplitHost(":4579", "", 8333));
    BOOST_CHECK(TestSplitHost("[]:4579", "", 8333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:4579", "127.0.0.1:8333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:4579", "[::]:8333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
