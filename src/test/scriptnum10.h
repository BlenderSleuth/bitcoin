...
#ifndef SCHLEEMS_TEST_SCRIPTNUM10_H
#define SCHLEEMS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Schleems Core 0.10.0, for cross-comparison.
 */
public:
