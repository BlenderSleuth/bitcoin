...
This document provides guidelines for internationalization of the Schleems Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `schleems_en.ts` remains unchanged.
