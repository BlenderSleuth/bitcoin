...
Then, to tunnel a SSL connection on 24578 to a RPC server bound on localhost on port 18332 do:

    stunnel -d 24578 -r 127.0.0.1:18332 -p stunnel.pem -P ''
...
- #7209 `f3ad812` test: don't override SCHLEEMSD and SCHLEEMSCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add SCHLEEMSD_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
...
- #6504 `b6fee6b` Rationalize currency unit to "SLM" (Ross Nicoll)
